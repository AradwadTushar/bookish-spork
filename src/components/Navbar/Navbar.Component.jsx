  ...
  return<>
    <div className='text-white flex items-center justify-between'>
      <div>
        ...
        <span className='text-gray-400 text-xs flex items-center cursor-pointer hover:text-white'>Bengalore</span>
      </div>
...
function NavMd () {
  return<>
      <div className='w-full flex items-center gap-3 bh-white px-3 py-1 rounded-md'>
        <BiSearch/>
...
function NavLg () {
  ...
  <div className='container flex mx-auto px-4 items-center justify-between'>
    ...
    <div className='w-10 h-10'>
      <img src="https://in.bmscdn.com/webin/common/icons/logo.svg" alt="" className='w-full h-full' />
    </div>
